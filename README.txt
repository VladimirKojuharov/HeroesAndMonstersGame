...
This java project is a console based game where the player has to choose between one of three character types (Mage, Fighter and Rogue) each with their own unique base stats (Life, Life Regain, Armor, Shield, Damage, Attack Speed, Crit Chance, Stun Chance, Spell Power, Magic Resistance, Mana, Mana Regeneration).

In the process of playing the game, the player will gain experience and LEVEL UP, change his stats, choose from many different spells to master (Heal, Fireball, Stone Skin, Mana Burn, Blind, Blizzard, Slow, Stun Strike, Haste, Life Drain), each with its own unique effect.
...
He/She will have to carefully select her opponents throughout all 40 levels. For each battle, there will be a choice between three creatures which, depending on the stage of the game it is in, can be:
